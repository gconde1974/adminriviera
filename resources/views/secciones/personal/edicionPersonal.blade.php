                ...
                <div class="body">
                    <form id="basic-form" method="post" novalidate action="#">  
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control" name="nombre" value="Fernando Parada Arriaga" required>
                        </div>
                        <div class="form-group">
                            <label>Sueldo</label>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="subtotal" class="form-control" name="sueldo" value="259">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>IMSS</label>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="subtotal" class="form-control" name="imss" value="120">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Puesto</label>
